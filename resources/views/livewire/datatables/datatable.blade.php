    ...
    <div class="relative">
        <div class="flex justify-between items-center mb-1">
            ...
            <div class="flex items-center space-x-1">
                ...
                @if($createBtn)
                    <a href="{{ $link }}" class="flex items-center space-x-2 px-3 border border-green-400 rounded-md bg-white text-green-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-200 focus:outline-none"><span>{{ __('Create') }}</span>
